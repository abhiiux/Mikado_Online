Shader "Custom/Outline"
{
    Properties
    {
        ...
        _OutlineWidth01     ("Outline Width", Range(0, 1))        = 0.1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                // Toggle gates whether the outline shows at all;
                // _OutlineWidth01 (inspector slider) controls how thick it is.
                float outlineWidth = (_OutlineWidth > 0.5) ? _OutlineWidth01 : 0.0;
                o.pos = TransformObjectToHClip(float4(v.vertex.xyz + v.normal * outlineWidth, 1));
